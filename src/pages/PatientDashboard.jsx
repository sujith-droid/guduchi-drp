    ...
    <div ref={containerRef} className="space-y-6 pb-20 md:pb-6 overflow-auto">
      ...
      {todayLog && (
        <div className="grid grid-cols-2 gap-3">
          <StatCard icon={Droplets} label="Morning (Before Food)" value={todayLog.before_food_morning || todayLog.fasting_sugar} unit="mg/dL" />
          <StatCard icon={Activity} label="Morning (After Food)" value={todayLog.after_food_morning || todayLog.post_breakfast_sugar} unit="mg/dL" />
